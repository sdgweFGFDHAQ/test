...
class CountDownLatchTest {
    ...
    public static void main(String[] args) {
        ...
        Worker w1 = new Worker("张三", getRandomWorkDuration(MIN_WORK_DURATION, MAX_WORK_DURATION));
        Worker w2 = new Worker("李四", getRandomWorkDuration(MIN_WORK_DURATION, MAX_WORK_DURATION));
